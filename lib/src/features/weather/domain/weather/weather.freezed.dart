...
class _$WeatherParamsCopyWithImpl<$Res, $Val extends WeatherParams>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      temp: null == temp ? _value.temp : temp as double,
      tempMin: null == tempMin ? _value.tempMin : tempMin as double,
      tempMax: null == tempMax ? _value.tempMax : tempMax as double,
    ) as $Val);
  }
}
...
class _$WeatherInfoCopyWithImpl<$Res, $Val extends WeatherInfo>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      main: null == main ? _value.main : main as String,
      description:
          null == description ? _value.description : description as String,
      icon: null == icon ? _value.icon : icon as String,
    ) as $Val);
  }
}
